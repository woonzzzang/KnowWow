...
const initial: Message = {
  role: "assistant",
  content: "과거 업무 기록, 담당자가 직접 확인한 경험, 여러 기록에서 반복된 처리 경향을 나누어 찾아봅니다. 제조 업무 상황을 편하게 입력해 주세요.",
};
